            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreateBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PriceMaterial = table.Column<int>(type: "int", nullable: true),
                    PriceDesign = table.Column<int>(type: "int", nullable: true),
                    ProcessPrice = table.Column<int>(type: "int", nullable: true),
